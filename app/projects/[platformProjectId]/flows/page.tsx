...
const CREATE_OPTIONS: Array<{ id: string; label: string; depth?: 'quick' | 'complete' }> = [
  ...
  { id: COLLECTION_FLOW_TEMPLATE_FIX_RETEST, label: 'Enterprise · Fix und Gegentest' },
  { id: COLLECTION_FLOW_TEMPLATE_LAUNCH_GATE, label: 'Enterprise · Launch-Gate' },
  { id: COLLECTION_FLOW_TEMPLATE_CRISIS, label: 'Enterprise · Krisenantwort' },
  {
