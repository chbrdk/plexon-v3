...
1. Specs first. Update `specs/domain` or `specs/api` before changing behavior. UI rebuild: `specs/domain/ui-migrate.md`. Project model: `specs/domain/collection-projects.md` (Collection = sole user-facing project; CHECKION/AUDION = capabilities).
