...
| Playwright | UC1, UC9 (Panes + Audit/Activity), E2 ClientRoom, E3, E5 templateId, E8 Crisis templateId, E9 Directory-Stub | `e2e/uc1-pitch-eqc.spec.ts` · `e2e/uc9-lagebild-audit.spec.ts` · `e2e/e2-client-room.spec.ts` · `e2e/e3-schedule-retest.spec.ts` · `e2e/e5-launch-gate.spec.ts` · `e2e/e8-crisis-template.spec.ts` · `e2e/e9-directory-stub.spec.ts` · `npm run test:e2e:staging` |
