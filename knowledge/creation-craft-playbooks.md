...
- **Craft modules (restyle / wireframe / PDP / social):** `lib/assistant/creation-craft-modules.ts` · restyle `knowledge/creation-craft-module-restyle.md` · PDP+social `knowledge/creation-craft-module-pdp-social.md`
