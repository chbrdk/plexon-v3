...
- **Spirion section modules (next):** `knowledge/creation-craft-spirion-section-modules.md`
- **Craft modules (restyle / wireframe / PDP / social / pricing / contact):** `lib/assistant/creation-craft-modules.ts` · restyle `knowledge/creation-craft-module-restyle.md` · PDP+social `knowledge/creation-craft-module-pdp-social.md` · pricing+contact `knowledge/creation-craft-module-pricing-contact.md`
