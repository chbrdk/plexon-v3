...
Wave 5: `external_connections_list` / `external_connection_sync`; `company_kpi_library_list` / `company_kpi_library_bind`; Cursor Settings Bearer (`knowledge/settings-api-tokens.md` in metron-v3).
