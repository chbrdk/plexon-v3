...
- VIDEON MCP (media/scenes/analysis/cuts — planned): `VIDEON_MCP_URL` · port **3103** · spec `specs/domain/assistant-videon-mcp.md` · `knowledge/videon-mcp-assistant.md` · product `videon-v3/specs/domain/mcp-server.md` (not wired in orchestrator yet)
