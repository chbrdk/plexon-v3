...
- METRON (Wave 2 auth+registry · Phase 8 done): product id `metron` · repo `https://github.com/chbrdk/metron-v3` · local `http://localhost:3011` · env `NEXT_PUBLIC_METRON_URL` / `METRON_API_URL` / `METRON_MCP_URL` · fit `knowledge/metron-ecosystem-fit.md` · onboarding `knowledge/metron-v3-onboarding.md` · domain `specs/domain/metron-capability.md` · FQDN TBD after Coolify smoke · launch `{METRON}/projects?platformProjectId=` · origin `POST /api/platform/provisioning/metron-project-origin` · upsert `{METRON}/api/platform/provisioning/projects/{platformProjectId}`
