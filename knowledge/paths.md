...
- Data-plane ops: `GET /api/platform/ops/data-plane` · outbox drain `POST /api/platform/ops/outbox/drain` · `API_PLATFORM_OPS_DATA_PLANE` / `API_PLATFORM_OPS_OUTBOX_DRAIN` · program `knowledge/plexon-data-plane-optimizations.md`
