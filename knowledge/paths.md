...
- DS tokens as Collection (program **DS-DEPOSIT**, D0–D4 + **D6** + **D7**): `knowledge/ds-tokens-as-plexon-project.md` → canonical `brandion-v3/knowledge/ds-tokens-as-plexon-project.md` · drift CI `brandion-v3/knowledge/ds-deposit-d6-operator.md` · spacing roles `brandion-v3/knowledge/ds-deposit-d7-operator.md` (Plexon hosts Collection only; Brandion owns pack; no token JSON here)
