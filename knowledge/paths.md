...
- CREATION Client Page Share (enterprise view-only for customers — **not** Collection invite): Spec `specs/domain/creation-client-share.md` · companion `creation-v3/specs/domain/client-page-share.md` · eval `creation-v3/knowledge/client-page-share-eval.md` · Creation hosts `/share/p/:token` + `crs_` tokens; Plexon owns org/Collection `clientShare` policy · P2 APIs `GET/PATCH …/client-share-policy` · `GET/POST …/client-shares` · `DELETE …/client-shares/:shareId` · **P4** Collection UI `components/projects/CollectionClientSharesPanel.tsx` on `/projects/:id` · revoke fans out to Creation provisioning DELETE · **P5** audit `POST …/client-share-events` · CSV `GET …/client-share-events/export` · constants `apiPlatformProvisioningCollectionClientSharePolicy` / `apiPlatformProvisioningCollectionClientShares` / `apiPlatformProvisioningCollectionClientShare` / `apiPlatformProvisioningCollectionClientShareEvents` / `apiPlatformProvisioningCollectionClientShareEventsExport` · migrations `0017_creation_client_share.sql` · `0018_creation_client_share_events.sql` · knowledge `knowledge/creation-client-share.md`
- Collection members roster (Access Model B): Spec `specs/api/collection-members.md` · `GET/POST /api/platform/provisioning/collections/:platformProjectId/members` · `DELETE …/members/:userId` · helpers `lib/collection-members.ts` · constants `apiPlatformProvisioningCollectionMembers` · ecosystem UI consumers: `knowledge/collection-team-ecosystem.md`
