...
- Suite Enterprise: activity `…/activity` · audit `…/audit` · campaign briefs `…/campaign-briefs` · share-links `…/share-links` (`apiPlatformProvisioningCollectionShareLinks`, spec `collection-share-links.md`) · client room `…/client-room` (API remains; Collection-Home UX deferred) · slot put `…/client-room/slots/{slotId}` · directory stub `GET/PATCH /api/admin/companies/:id/directory` · knowledge `knowledge/suite-enterprise-program.md` · slot contract `knowledge/client-room-slots.md`
