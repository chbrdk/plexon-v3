...
- METRON public dashboard share: `/share/metron/:token` · `POST /api/assistant/metron/dashboards/share` · `GET /api/public/metron/:token` · spec `specs/domain/assistant-metron-share.md` · constants `PATH_SHARE_METRON` / `pathShareMetron` / `apiPublicMetron` / `apiAssistantMetronDashboardShare`
