...
- Suite Enterprise: activity `…/activity` · audit `…/audit` · campaign briefs `…/campaign-briefs` · client room `…/client-room` · slot put `…/client-room/slots/{slotId}` (`apiPlatformProvisioningCollectionClientRoomSlot`) · directory stub `GET/PATCH /api/admin/companies/:id/directory` · knowledge `knowledge/suite-enterprise-program.md` · slot contract `knowledge/client-room-slots.md`
