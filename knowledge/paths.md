...
- BRANDION MCP (guidelines/tokens): `BRANDION_MCP_URL` → prefer `http://brandion-mcp:3100` · spec `specs/domain/assistant-brandion-mcp.md` · gate/knowledge `knowledge/brandion-mcp-assistant.md` · product MCP `brandion-v3/mcp-server/`
