...
- METRON MCP (KPIs/dashboards): `METRON_MCP_URL` → Coolify `metron-mcp` (attach under `MSQDX-Metron-v3`) port **3104** · spec `specs/domain/assistant-metron-mcp.md` · `knowledge/metron-mcp-assistant.md` · product `metron-v3/mcp-server/`
