...
- ECHON MCP (signals/waves/foresight/research): `ECHON_MCP_URL` → Coolify `echon-mcp` port **3101** · spec `specs/domain/assistant-echon-mcp.md` · product MCP `echon-v3/mcp-server/`
