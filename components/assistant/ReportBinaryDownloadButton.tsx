...
function mapSize(size: ReportBinaryDownloadButtonProps['size']): 'sm' | 'md' {
...
export function ReportBinaryDownloadButton({
  ...
  return (
    <div className="plexon-report-download">
      <Button variant="ghost" size={mapSize(size)} disabled={loading} onClick={() => void download()}>
        {loading ? loadingLabel : label}
      </Button>
      {error ? (
        <Text role="meta" data-tone="danger">
          {error}
        </Text>
      ) : null}
    </div>
