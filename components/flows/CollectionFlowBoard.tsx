...
import { PALETTE_BRAND_GROUPS, PALETTE_ENTERPRISE_GROUPS, PALETTE_JOURNEY_GROUPS, PALETTE_MEDIA_GROUPS, PALETTE_QUALITY_GROUPS } from '@/lib/collection-flow-presets'
import {
        ...
        <>
          ...
          >
            ...
            >
              ...
              {PALETTE_ENTERPRISE_GROUPS.map((group) => (
                <div key={group.id}>
                  <p className="msqdx-flow-canvas-hint">{group.title}</p>
                  <div className="msqdx-flow-palette-row">
                    {group.presets.map((preset) => (
