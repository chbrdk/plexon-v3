...
const PILOT: CapabilityRecord[] = [
  ...
  },
  {
    ...
    description: 'Capture a URL or asset into SPIRION (stub until Wave 2).',
    inputFields: [
      { name: 'platformProjectId', required: true },
      { name: 'url', required: false },
    ],
    ...
    flow: null,
    executorId: 'spirion-stub',
  },
  {
    id: 'spirion.enrich',
    owner: 'spirion',
    title: 'Enrich design capture',
    description: 'Run LLM enrichment on a SPIRION capture (stub until Wave 2).',
    inputFields: [
      { name: 'platformProjectId', required: true },
  ...
  {
    id: 'spirion.reference_search',
    owner: 'spirion',
    title: 'Search design references',
    description: 'Search Collection-scoped design references in SPIRION (stub until Wave 2).',
    inputFields: [
      { name: 'platformProjectId', required: true },
  ...
  {
    id: 'spirion.reference_pack',
    owner: 'spirion',
    title: 'Build reference pack',
    description: 'Assemble a design reference pack from SPIRION library hits (stub until Wave 2).',
    inputFields: [
      { name: 'platformProjectId', required: true },
  ...
  },
  {
    ...
    description: 'Generate design variants grounded in SPIRION references (stub until Wave 2).',
    inputFields: [
      { name: 'platformProjectId', required: true },
  ...
  {
    id: 'videon.media.search',
    owner: 'videon',
    title: 'Media search',
    description: 'VIDEON scene / media search; optional media.search catalog (Agent explore).',
    inputFields: [
      { name: 'platformProjectId', required: true },
      { name: 'query', required: true },
    ],
    outputCatalogRoot: 'media.search',
    sideEffect: 'read',
    confirmation: 'none',
    surfaces: { agent: true, flow: false },
    agent: {
  ...
  {
    id: 'videon.analysis.get',
    owner: 'videon',
    title: 'Media analysis status',
    description: 'VIDEON analysis / media lifecycle read; writes media.analysis catalog.',
    inputFields: [
      { name: 'platformProjectId', required: true },
      { name: 'mediaAssetId', required: true },
    ],
    outputCatalogRoot: 'media.analysis',
    sideEffect: 'read',
    confirmation: 'none',
    surfaces: { agent: true, flow: false },
    agent: {
      toolNames: ['videon_analysis_get', 'videon_media_get'],
      intentTypes: [],
    },
    flow: null,
    executorId: 'videon-analysis-get',
  },
  {
    id: 'videon.analysis.run',
    owner: 'videon',
    title: 'Run media analysis',
    description: 'Enqueue VIDEON media analysis job; writes media.analysis catalog.',
    inputFields: [
      { name: 'platformProjectId', required: true },
      { name: 'mediaAssetId', required: true },
    ],
    ...
    surfaces: { agent: true, flow: true },
    agent: {
      toolNames: ['videon_analysis_run'],
      intentTypes: [],
    },
    flow: { nodeKinds: ['videon_analysis_run'] },
    executorId: 'videon-analysis-run',
  },
  {
  ...
  },
  {
    ...
    description:
      'Enqueue VIDEON cut export (Flow-first; format mp4|premiere_xml ZIP); writes media.export catalog.',
    inputFields: [
      { name: 'platformProjectId', required: true },
      { name: 'cutId', required: true },
    ...
    sideEffect: 'job',
    confirmation: 'none',
    surfaces: { agent: false, flow: true },
    agent: null,
  ...
  {
    id: 'videon.generate.edit',
    owner: 'videon',
    title: 'AI clip edit',
    description:
      'Enqueue VIDEON fal V2V generative edit; writes media.generate catalog. No Flow node / no Hit-Card.',
    inputFields: [
      { name: 'platformProjectId', required: true },
      { name: 'mediaAssetId', required: true },
      { name: 'startMs', required: true },
      { name: 'endMs', required: true },
      { name: 'prompt', required: true },
      { name: 'modelId', required: false },
    ],
    outputCatalogRoot: 'media.generate',
    sideEffect: 'job',
    confirmation: 'human_gate',
    surfaces: { agent: true, flow: false },
    agent: {
      toolNames: ['videon_generate_edit_run'],
      intentTypes: [],
    },
    flow: { nodeKinds: [] },
    executorId: 'videon-generate-edit-run',
  },
  {
    id: 'videon.generate.create',
    owner: 'videon',
    title: 'AI clip create',
    description:
      'Enqueue VIDEON T2V/I2V create; writes media.generate catalog. No Flow node / no Hit-Card.',
    inputFields: [
      { name: 'platformProjectId', required: true },
      { name: 'prompt', required: true },
      { name: 'modelId', required: false },
    ...
    surfaces: { agent: true, flow: false },
    agent: {
      toolNames: ['videon_generate_create_run'],
      intentTypes: [],
    },
    flow: { nodeKinds: [] },
    executorId: 'videon-generate-create-run',
  },
  {
    id: 'metron.health',
    owner: 'metron',
    title: 'METRON health',
    description: 'METRON product liveness probe.',
    inputFields: [],
    outputCatalogRoot: null,
    sideEffect: 'read',
    confirmation: 'none',
    surfaces: { agent: true, flow: false },
    agent: { toolNames: ['metron_health'], intentTypes: [] },
    flow: null,
    executorId: 'metron-read',
  },
  {
    id: 'metron.projects.list',
    owner: 'metron',
    title: 'List METRON projects',
    description: 'List Collection capability mirrors in METRON.',
    inputFields: [],
    outputCatalogRoot: 'metron.projects',
    sideEffect: 'read',
    confirmation: 'none',
    surfaces: { agent: true, flow: false },
    agent: { toolNames: ['metron_projects_list'], intentTypes: [] },
    flow: null,
    executorId: 'metron-read',
  },
  {
    id: 'metron.datasets.list',
    owner: 'metron',
    title: 'List METRON datasets',
    description: 'List datasets (optional Collection filter).',
    inputFields: [{ name: 'platformProjectId', required: false }],
    outputCatalogRoot: 'metron.datasets',
    sideEffect: 'read',
    confirmation: 'none',
    surfaces: { agent: true, flow: false },
    agent: { toolNames: ['metron_datasets_list'], intentTypes: [] },
    flow: null,
    executorId: 'metron-read',
  },
  {
    id: 'metron.kpis.list',
    owner: 'metron',
    title: 'List METRON KPIs',
    description: 'List KPI definitions (optional Collection filter).',
    inputFields: [{ name: 'platformProjectId', required: false }],
    outputCatalogRoot: 'metron.kpis',
    sideEffect: 'read',
    confirmation: 'none',
    surfaces: { agent: true, flow: false },
    agent: { toolNames: ['metron_kpis_list'], intentTypes: [] },
    flow: null,
    executorId: 'metron-read',
  },
  {
    id: 'metron.dashboards.list',
    owner: 'metron',
    title: 'List METRON dashboards',
    description: 'List dashboards (optional Collection filter).',
    inputFields: [{ name: 'platformProjectId', required: false }],
    outputCatalogRoot: 'metron.dashboards',
    sideEffect: 'read',
    confirmation: 'none',
    surfaces: { agent: true, flow: false },
    agent: { toolNames: ['metron_dashboards_list'], intentTypes: ['metron_analytics'] },
    flow: null,
    executorId: 'metron-read',
  },
  {
    id: 'metron.dashboard.get',
    owner: 'metron',
    title: 'Get METRON dashboard',
    description: 'Dashboard detail + evaluations.',
    inputFields: [
    ...
    confirmation: 'none',
    surfaces: { agent: true, flow: false },
    agent: { toolNames: ['metron_dashboard_get'], intentTypes: [] },
    flow: null,
    executorId: 'metron-read',
  },
  {
    ...
    description: 'Bounded text summary + deep link for assistant replies.',
    inputFields: [{ name: 'id', required: true }],
    outputCatalogRoot: 'metron.dashboards',
    sideEffect: 'read',
    confirmation: 'none',
    surfaces: { agent: true, flow: false },
    agent: { toolNames: ['metron_dashboard_summarize'], intentTypes: [] },
    flow: null,
    executorId: 'metron-read',
  },
  {
    id: 'metron.dashboard.create',
    owner: 'metron',
    title: 'Create METRON dashboard',
    description: 'Create a Collection dashboard (chat confirm).',
    inputFields: [
      { name: 'platformProjectId', required: true },
      { name: 'name', required: true },
      { name: 'templateId', required: false },
      { name: 'kpiIds', required: false },
    ],
    outputCatalogRoot: 'metron.dashboards',
    sideEffect: 'write',
    confirmation: 'human_gate',
    surfaces: { agent: true, flow: false },
    agent: { toolNames: ['metron_dashboard_create'], intentTypes: [] },
    flow: null,
    executorId: 'metron-write',
  },
  {
    id: 'metron.kpi.starter_pack_install',
    owner: 'metron',
    title: 'Install METRON KPI starter pack',
    description: 'Install HDI recruiting KPI pack (chat confirm).',
    inputFields: [
      { name: 'platformProjectId', required: true },
      { name: 'packId', required: false },
    ],
    outputCatalogRoot: 'metron.kpis',
    sideEffect: 'write',
    confirmation: 'human_gate',
    surfaces: { agent: true, flow: false },
    agent: { toolNames: ['metron_kpi_starter_pack_install'], intentTypes: [] },
    flow: null,
    executorId: 'metron-write',
  },
  {
    id: 'metron.suite_connectors.sync',
    owner: 'metron',
    title: 'Sync METRON suite connector',
    description: 'Pull CHECKION/AUDION/knowledge_pack snapshot (chat confirm).',
    inputFields: [
      { name: 'platformProjectId', required: true },
      { name: 'kind', required: true },
    ],
    outputCatalogRoot: 'metron.suite',
    sideEffect: 'job',
    confirmation: 'human_gate',
    surfaces: { agent: true, flow: false },
    agent: { toolNames: ['metron_suite_connectors_sync'], intentTypes: [] },
    flow: null,
    executorId: 'metron-write',
  },
];
