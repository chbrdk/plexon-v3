...
export const CREATION_CRAFT_EVAL_BRIEFS: CreationCraftEvalBrief[] = [
  ...
  { id: 'de-nav-39', lang: 'de', prompt: 'Landing mit schlanker Top-Nav Header und Primary CTA', category: 'landing', expectedPlaybookId: 'creation_landing_v1' },
  { id: 'en-nav-40', lang: 'en', prompt: 'Add a slim site header navigation bar with logo links and CTA', category: 'landing', expectedPlaybookId: 'creation_landing_v1' },
  { id: 'de-stats-41', lang: 'de', prompt: 'Kennzahlen Zahlenband mit vier Metrics unter dem Hero', category: 'landing', expectedPlaybookId: 'creation_landing_v1' },
  { id: 'en-stats-42', lang: 'en', prompt: 'Add a KPI metrics strip with four stats below the hero', category: 'landing', expectedPlaybookId: 'creation_landing_v1' },
  { id: 'de-faq-43', lang: 'de', prompt: 'FAQ Accordion mit häufigen Fragen und kurzen Antworten', category: 'landing', expectedPlaybookId: 'creation_landing_v1' },
  { id: 'en-faq-44', lang: 'en', prompt: 'Add an FAQ accordion with Q and A rows', category: 'landing', expectedPlaybookId: 'creation_landing_v1' },
  { id: 'de-bento-45', lang: 'de', prompt: 'Vorteile Feature-Bento ungleich 2+1 Grid', category: 'landing', expectedPlaybookId: 'creation_landing_v1' },
  { id: 'en-bento-46', lang: 'en', prompt: 'Build an asymmetric feature bento grid section', category: 'landing', expectedPlaybookId: 'creation_landing_v1' },
  { id: 'de-quote-47', lang: 'de', prompt: 'Kundenstimme Zitat-Section mit Name und Rolle', category: 'landing', expectedPlaybookId: 'creation_landing_v1' },
  { id: 'en-quote-48', lang: 'en', prompt: 'Add a customer testimonial quote with name and role', category: 'landing', expectedPlaybookId: 'creation_landing_v1' },
  { id: 'de-blog-49', lang: 'de', prompt: 'Blog Artikelübersicht mit Teaser-Liste', category: 'landing', expectedPlaybookId: 'creation_landing_v1' },
  { id: 'en-blog-50', lang: 'en', prompt: 'Build a news blog list with title meta and teaser', category: 'landing', expectedPlaybookId: 'creation_landing_v1' },
  { id: 'de-brand-51', lang: 'de', prompt: 'Brandion Tokens binden active pack set_token_binding auf die Landing', category: 'landing', expectedPlaybookId: 'creation_landing_v1' },
  { id: 'en-brand-52', lang: 'en', prompt: 'Bind Brandion active pack tokens via set_token_binding', category: 'landing', expectedPlaybookId: 'creation_landing_v1' },
  { id: 'de-chapter-53', lang: 'de', prompt: 'Magazin Cover Chapter Folio Seitenfolge PrintPage', category: 'print', expectedPlaybookId: 'creation_print_magazine_v1' },
  { id: 'en-chapter-54', lang: 'en', prompt: 'Print magazine cover chapter folio rhythm multi-page', category: 'print', expectedPlaybookId: 'creation_print_magazine_v1' },
