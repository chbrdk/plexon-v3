...
function buildCreationEditorContextBlock(pageContext: AssistantPageContext): string {
  ...
  lines.push(
    ...
    'Insert: bevorzugt insert_child { parentId, child: { id, type, props } } mit echter Copy — keine Seed-Texte (Get started, Option A, Text, Link). insert_instance nur mit props oder sofort set_prop. Niemals insert_node / add_instance / append_child.',
