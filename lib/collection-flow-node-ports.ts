...
export const NODE_IO_BY_KIND: Partial<Record<CollectionFlowNodeKind, NodeIoSchema>> = {
  ...
  videon_media: { inputs: [FLOW_IN], controlOutputs: [THEN_OUT], catalogOutputs: false },
  videon_analysis_run: { inputs: [FLOW_IN], controlOutputs: [THEN_OUT], catalogOutputs: true },
  videon_cut_create: { inputs: [FLOW_IN], controlOutputs: [THEN_OUT], catalogOutputs: true },
  videon_export_run: { inputs: [FLOW_IN], controlOutputs: [THEN_OUT], catalogOutputs: true },
